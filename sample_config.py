...
class Config(object):
    ...
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "thanos")
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/thanosuserss/Ultron"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "UltronUserBot")
    ...
    # Google Drive plugin https://graph.org/G-Drive-guide-for-UltronUserBot-01-01
