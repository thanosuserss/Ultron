...
def file_check():
    ...
    if not os.path.exists(logo):
        urllib.request.urlretrieve(
            "https://github.com/thanosuserss/Ultron-Resources/raw/master/Resources/Spotify/cat.png",
            logo,
        )
    if not os.path.exists(font_mid):
        urllib.request.urlretrieve(
            "https://github.com/thanosuserss/Ultron-Resources/blob/master/Resources/Spotify/GoogleSans-Medium.ttf?raw=true",
            font_mid,
        )
...
async def make_thumb(url, client, song, artist, now, full):
    ...
    try:
        ...
        myphoto = urllib.request.urlretrieve(
            "https://github.com/thanosuserss/Ultron-Resources/raw/master/Resources/Spotify/SwagCat.jpg"
        )
...
async def spotify_inline_article():
    thumb = None
    media = "https://github.com/thanosuserss/Ultron-Resources/raw/master/Resources/Inline/spotify_off.png"
    if (
        ...
        if response.status_code == 204:
            ...
            thumb = "https://github.com/thanosuserss/Ultron-Resources/raw/master/Resources/Inline/spotify_on.png"
